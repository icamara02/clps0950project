...
%remove any blank columns in which there is no variable in the first row 
proc_data (:,6:10) = [];

%delete rows in which the "Congruency” column has “CN_Neutral”, “GC_Neutral” or “practice”
